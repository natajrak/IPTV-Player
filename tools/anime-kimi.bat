...
echo.
echo  ^ node fetch-anime-kimi.js %URL% --track=%TRACK% --season=%SEASON% --output=%OUTPUT%
echo.
node fetch-anime-kimi.js %URL% --track=%TRACK% --season=%SEASON% --output=%OUTPUT%
goto DONE
...
echo.
set "CMD=node fetch-anime-kimi.js"
